...
{{--                                </div>--}}
                                ...
                                <li>
                                    @if(Session::get('customer_id'))
                                    <div class="ht-setting-trigger"><span>Hello {{Session::get('customer_name')}} </span></div>
                                    @endif
                                    <div class="">
                                ...
                                <li>
                                    ...
                                    <div class="language ht-language">
                                        <ul class="ht-setting-list">
                                            <li class="active"><a href="#"><img src="{{asset('/')}}front/assets/images/menu/flag-icon/1.jpg" alt="">English</a></li>
                                            <li><a href="#"><img src="{{asset('/')}}front/assets/images/menu/flag-icon/2.jpg" alt="">Français</a></li>
                                        </ul>
                                    </div>
                                </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="logo pb-sm-30 pb-xs-30">
                            <a href="{{route('home')}}">
                                <img src="{{asset('/')}}front/assets/images/menu/logo/1.jpg" alt="">
                            </a>
                        </div>
                    </div>
                                        ...
                                        <ul class="minicart-product-list">
                                            <li>
                                                <a href="single-product.html" class="minicart-product-image">
                                                    <img src="{{asset('/')}}front/assets/images/product/small-size/3.jpg" alt="cart products">
                                                </a>
                                            ...
                                            <li>
                                                <a href="single-product.html" class="minicart-product-image">
                                                    <img src="{{asset('/')}}front/assets/images/product/small-size/4.jpg" alt="cart products">
                                                </a>
                                                <div class="minicart-product-details">
                                                    <h6><a href="single-product.html">Aenean eu tristique</a></h6>
                                                    <span>£80 x 1</span>
                            ...
                            <nav>
                                <ul>
                                    ...
                                    <li class="hb-info f-right p-0 d-sm-none d-lg-block">
                                        <span>100ft, Noyabari, Madani Avenue, Vatara, Dhaka-1212</span>
                                    </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <ul class="des">
                                <li>
                                    <span>Address: </span>
                                    100ft, Noyabari, Madani Avenue, Vatara, Dhaka-1212
                                </li>
                                <li>
                                    <span>Phone: </span>
                                    <a href="#">(+088) 1515 253 203</a>
                                </li>
                                <li>
                                    <span>Email: </span>
                                    <a href="mailto://cse.momin71@gmail.com">cse.momin71@gmail.com</a>
                                </li>
                            </ul>
                        </div>
