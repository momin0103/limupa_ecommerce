    ...
    <div class="col-lg-10 mx-auto">
        <div class="card">
            <div class="card-header">
                <h3 class="text-dark text-center text-bold">Edit Sub Category Form</h3>
            ...
            <div class="card-body card-block">
                ...
                <form action="{{route('update-sub-category', ['id' => $subCategory->id])}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" id="hf-email" name="name" value="{{$subCategory->name}}" placeholder="Enter sub category name..." class="form-control">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <textarea type="text" id="hf-email" name="description" placeholder="Enter sub category description..." class="form-control">{{$subCategory->description}}</textarea>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary btn-group-sm btn btn-block"><i class="fa fa-dot-circle-o"></i>Update New Sub Category</button>
                    </div>
                </form>
