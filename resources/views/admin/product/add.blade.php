    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="text-dark text-center text-bold">Add Product Form</h3>
            ...
            <div class="card-body card-block">
                ...
                <form action="{{route('new-product')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" id="hf-email" name="name" placeholder="Enter product name..." class="form-control">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" id="hf-email" name="code" placeholder="Enter product code..." class="form-control">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="number" id="hf-email" name="regular_price" placeholder="Enter regular price..." class="form-control">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="number" id="hf-email" name="selling_price" placeholder="Enter selling price..." class="form-control">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <textarea type="text" id="hf-email" name="short_description" placeholder="Enter product short description..." class="form-control"></textarea>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <textarea type="text" id="hf-email" name="long_description" placeholder="Enter product long description..." class="form-control summernote"></textarea>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            ...
                            <span class="help-block">Please choice your product image</span>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3">
                        ...
                        <div class="col-12 col-md-9">
                            ...
                            <span class="help-block">Please choice your product sub images</span>
                        </div>
                    </div>
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary btn-group-sm btn btn-block"><i class="fa fa-dot-circle-o"></i>Create New Product</button>
                    </div>
                </form>
