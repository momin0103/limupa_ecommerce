...
use App\Http\Controllers\LimupaController;
...
Route::get('/', [LimupaController::class, 'index'])->name('home');
Route::get('/category-product/{id}', [LimupaController::class, 'categoryProduct'])->name('category-product');
Route::get('/sub-category-product/{id}', [LimupaController::class, 'subCategoryProduct'])->name('sub-category-product');
Route::get('/product-detail/{id}', [LimupaController::class, 'productDetail'])->name('product-detail');
...
Route::get('/delete-card-item/{id}', [CartController::class, 'delete'])->name('delete-card-item');
...
Route::middleware(['customer'])->get('/customer-dashboard', [CustomerDashboardController::class, 'index'])->name('customer-dashboard');
Route::middleware(['customer'])->get('/customer-change-password', [CustomerDashboardController::class, 'changePassword'])->name('customer-change-password');
Route::middleware(['customer'])->post('/update-customer-password', [CustomerDashboardController::class, 'updatePassword'])->name('update-customer-password');
...
Route::get('/admin-change-parssword', [ProfileController::class, 'changePassword'])->name('admin-change-parssword');
